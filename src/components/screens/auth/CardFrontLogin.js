    ...
    return (
        <div className="row g-0 pb-5">
            <div className="col-sm-6 col-md-6 rounded" style={{ height: "auto" }}>
                <img className="img-fluid img-thumbnail border-0 pb-5 pt-5 pe-2 ps-2" style={{ height: "80vh", width: "100%" }} src="https://img.freepik.com/vector-gratis/ilustracion-concepto-olvide-contrasena_114360-1123.jpg?size=338&ext=jpg" alt="LoginIMG" />
            </div>
